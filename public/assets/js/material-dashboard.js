...
function showError(input, message) {
  ...
  formControl.className = 'my-5 input-group input-group-outline is-invalid is-filled';
...
function showSucces(input) {
  const formControl = input.parentElement;
  formControl.className = 'my-5 input-group input-group-outline is-valid is-filled';
}
